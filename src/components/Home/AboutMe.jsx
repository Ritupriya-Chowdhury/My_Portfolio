  ...
  return (
    ...
    >
      ...
      <div className="py-8 lg:flex">
        ...
        <div className="lg:w-72 lg:h-72 w-80 h-80 rounded-full overflow-hidden mx-auto">
          <img
            src={MyImg}
        ...
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Name</p>
                    <p className="text-2xl font-semibold py-2">Ritupriya Chowdhury</p>
                </div>
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Email</p>
                    <p className="text-2xl font-semibold py-2">ritupriyabgc@gmail.com</p>
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Phone</p>
                    <p className="text-2xl font-semibold py-2">+880 16215 79052</p>
                </div>
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Address</p>
                    <p className="text-2xl font-semibold py-2">Chattogram, Bangladesh</p>
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Nationality</p>
                    <p className="text-2xl font-semibold py-2">Bangladeshi</p>
                </div>
                <div className="border-b border-gray-500 py-4 mx-4">
                    <p className="text-3xl font-bold text-[#FC4319] pb-2">Hobbies</p>
